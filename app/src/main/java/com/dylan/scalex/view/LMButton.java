...
public class LMButton extends Button {
    private static final String TAG = LMButton.class.getSimpleName();
    ...
    public LMButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        checkCustomAttributes(context, attrs);
    }

    public LMButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        checkCustomAttributes(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LMButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
